...
namespace Unity.Entities.Tests
{
    class UpdateOrderOptimizerTests : ECSTestsFixture
	{
        ...
        public UpdateOrderOptimizerTests()
        {
            ...
            m_fakePlayerLoop.subSystemList[0].type = typeof(UnityEngine.PlayerLoop.Initialization);
            m_fakePlayerLoop.subSystemList[0].subSystemList = new PlayerLoopSystem[0];
            m_fakePlayerLoop.subSystemList[1].type = typeof(UnityEngine.PlayerLoop.Update);
            m_fakePlayerLoop.subSystemList[1].subSystemList = new PlayerLoopSystem[2];
            m_fakePlayerLoop.subSystemList[1].subSystemList[0].type = typeof(UnityEngine.PlayerLoop.Update.ScriptRunBehaviourUpdate);
            m_fakePlayerLoop.subSystemList[1].subSystemList[1].type = typeof(UnityEngine.PlayerLoop.Update.ScriptRunDelayedDynamicFrameRate);
            m_fakePlayerLoop.subSystemList[2].type = typeof(UnityEngine.PlayerLoop.PostLateUpdate);
        ...
        [UpdateAfter(typeof(UnityEngine.PlayerLoop.Initialization))]
        [DisableAutoCreation]
