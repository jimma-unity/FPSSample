private List<ShaderVariantRule> LoadRules()
{
    var rules = new List<ShaderVariantRule>
    {
        new("Deferred_Indirect_Fptl_Variant2", "TextMeshPro/Distance Field (instance 0x1DE)", "<Unnamed Pass 0>", new List<string>
            {
                "vertex",
            }),
        ...
        new("Hidden/VFX/Spaceship_Background_A_Engine_Thruster/System", "<Unnamed Pass 0>", "pixel", new List<string>
            {
            }),
        new("Hidden/VFX/Spaceship_Background_A_Engine_Thruster/System", "<Unnamed Pass 0>", "vertex", new List<string>
            {
            }),
