...
#pragma warning restore 618
        ...
        {
            var componentTypes = new NativeArray<ComponentType>(128, Allocator.TempJob); //stackalloc ComponentType[128];
            ...
            ReadOnlySpan<ComponentType> componentTypesSpan= componentTypes.GetSubArray(0, componentsCache.Count).AsReadOnlySpan();

            EntityArchetype archetype = entityManager.CreateArchetype(componentTypesSpan);
    ...
    {
        public static unsafe bool GetComponents(this GameObject @this, NativeArray<ComponentType> componentTypes,
